...
export default function ChaptersPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-8">
      ...
      {/* Generate quiz with ChatGPT button - always visible */}
      <div className="flex justify-end mb-6">
        <button
          className="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-md shadow-sm transition duration-150 ease-in-out"
          onClick={() => {
