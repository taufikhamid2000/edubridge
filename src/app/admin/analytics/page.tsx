      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-gray-500 text-sm">Daily Active Users</h3>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-gray-500 text-sm">Quiz Attempts</h3>
                <p className="text-3xl font-bold">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            <h2 className="text-xl font-medium mb-4">User Activity</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-medium mb-4">Most Active Subjects</h2>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-medium mb-4">User Demographics</h2>
              <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
