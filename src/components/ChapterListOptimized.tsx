        ...
        .map((form: string) => (
          <div key={form} className="mb-6">
            ...
            <ol className="list-decimal pl-6 space-y-3">
              {groupedChapters[Number(form)].map(
                  ...
                  <li key={chapter.id} className="mb-2">
                    <div className="bg-gray-800 dark:bg-white rounded-lg shadow-sm border border-gray-700 dark:border-gray-200">
                      <button
                        ...
                        className="text-left w-full p-4 hover:bg-gray-500 dark:hover:bg-gray-300 rounded-lg transition-colors duration-200 flex items-center justify-between"
                      >
                        <span className="font-medium text-gray-100 dark:text-gray-900">
                          {chapter.name}
                        </span>
                      ...
                      {expandedChapters[chapter.id] && (
                        <div className="px-4 pb-4 border-t border-gray-600 dark:border-gray-100 bg-gray-50 dark:bg-gray-750">
                          {chapter.topics && chapter.topics.length > 0 ? (
                            ...
                            <div className="mt-3 text-center py-6">
                              <svg
                                className="mx-auto h-8 w-8 text-gray-900 dark:text-gray-600 mb-2"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
